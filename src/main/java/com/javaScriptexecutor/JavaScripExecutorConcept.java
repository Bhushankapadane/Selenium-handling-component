...
public class JavaScripExecutorConcept {
    ...
    driver.get("file:///C:/Users/ADMIN/Desktop/selenium%20exel/Offline%20Website/index.html");
	
    driver.findElement(By.xpath("//input[contains(@id,'email')]")).sendKeys("kiran@gmail.com");
	...
	//driver.findElement(By.xpath("//input[contains(@type,'submit')]")).click();
      //driver.findElement(By.xpath("//input[contains(@type,'submit')]")).click();
			...
			WebElement loginBtn = driver.findElement(By.xpath("//button[contains(@type,'submit')]")); //login button
			...
			FileUtils.copyFile(src, new File("D:\\selenium\\SeleniumHanlingElement\\Screenshots\\login.png"));
